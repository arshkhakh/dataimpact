	...
	return (
		<>
			<div
				...
				} group overflow-x-hidden hover:bg-black group-hover:bg-black py-9 md:hidden`}>
				<div className="flex ml-[4rem] mr-[4rem] giga items-center justify-between md:justify-end lg:ml-[2rem] lg:mr-[2rem]">
					<img
						className={`invert lg:w-[100px] md:hidden`}
						src="/logo_bg.png"
						alt="Logo"
						width="120"
						height="80"
					/>
					<ul className="ml-[10rem] text-white flex md:hidden">
						<li
							className={` ${
								nav ? `text-white` : `giga`
							...
							<Link className="hover:text-white hover:font-semibold" href="/">
								Home
							</Link>
						</li>
						<li
						...
						<li
							...
							<div className="hover:text-white hover:font-semibold">
								Services
							</div>
						</li>
						<li

...
const Mobile_Header = () => {
	...
	return (
		<>
			{/* MOBILE NAVIGATION */}
			<div className="select-none flex overflow-hidden items-center justify-between md:h-[5rem] my-[1rem] mx-[4rem] sm:mx-[2rem]">
				<img className="invert" src="/logo_bg.png" width="100" alt="Photo" />

				<div className=" ">
					<button
						onClick={() => setNav(!nav)}
						className=" z-[99999999	9] text-2xl select-none rotate-90 text-white focus:outline-none sm:mr-[1rem]">
						|||
					</button>
				</div>
			</div>
			<div
				...
				} transition-all duration-[400ms] ease-in-out fixed bg-transparent blurry_bg w-[70%] sm:w-[100%] h-screen  z-[999]`}>
				<div className="">
					<button
						onClick={() => setNav(!nav)}
